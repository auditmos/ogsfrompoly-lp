...
summary: poly-track weekly statement — 0 alerts, hit rate 0.00.
...
Generated from poly-track warehouse for the weekly window 2026-05-25 → 2026-05-31. 0 alerts emitted in this window across the LP-public categories (politics, macro-finance, crypto). Numbers in the frontmatter are mechanically derived; commentary below is left blank for the operator to fill before flipping `draft: false`.
